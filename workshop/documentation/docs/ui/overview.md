...
| Go UI | `ui/goth` plus feature view adapters | the host should compose and serve HTML from Go |

UI packages sit outside feature cores. They may provide components, tokens, controllers, renderers, or client conventions, but they do not own feature schemas, persistence, or host lifecycle.
