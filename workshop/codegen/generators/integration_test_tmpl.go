...
{{if not .HasAnyTest}}//
// No standard store probes were generated for this entity (skipped via
// @skip-integration-test, or no single-PK Get/List/Delete/Update is usable
// from the generic fixtures). setupTestStore is provided for hand-written
// tests — add them in store_test.go.
{{end}}
package {{.StorePkg}}
...
{{if .HasAnyTest}}	"github.com/stretchr/testify/assert"
{{end}}{{if or .SpecMode .HasAnyTest}}	"github.com/stretchr/testify/require"
{{end}}{{if .NeedsRepoImport}}
	"{{.RepoImport}}"
{{end}}{{if .HasAnyTest}}
	fixtures "{{.FixtureImport}}"
{{end}}
{{if .SpecMode}}	"github.com/gopernicus/gopernicus/workshop/testing/testsqlite"
{{else}}{{if .HasAnyTest}}	"github.com/gopernicus/gopernicus/workshop/testing/pgxfixtures"
{{end}}	"github.com/gopernicus/gopernicus/workshop/testing/testpgx"
