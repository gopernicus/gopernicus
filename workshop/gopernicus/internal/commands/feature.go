...
func emitFeature(targetDir string, p featureParams) error {
	...
	files := []templateFile{
		...
		{Template: "templates/feature/stores/turso/helpers.go.tmpl", Out: filepath.Join("stores", "turso", "helpers.go"), Format: true},
		...
		{Template: "templates/feature/stores/pgx/helpers.go.tmpl", Out: filepath.Join("stores", "pgx", "helpers.go"), Format: true},
