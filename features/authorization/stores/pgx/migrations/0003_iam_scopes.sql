...
-- (mutation.ScopeKey / mutation.Revision, AZ3-0.4). PostgreSQL flavor of the turso
-- 0003 — IDENTICAL filename so the version set matches across dialects.
--
...
-- negative revision (revision is a mutation.Revision / uint64 counter; BIGINT
-- holds the full monotonic range in practice).
