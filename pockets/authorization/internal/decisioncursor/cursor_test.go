...
func testFingerprint() string {
	return LookupFingerprint("relationship", "digest-1", authmodel.PrincipalRef{Type: "user", ID: "u1"}, "view", "project")
}
...
func TestDecodeLookupCursorRefusesEveryMalformedOrForeignCursor(t *testing.T) {
	fp := testFingerprint()
	other := LookupFingerprint("role", "digest-1", authmodel.PrincipalRef{Type: "user", ID: "u1"}, "view", "project")
...
func TestLookupFingerprintBindsEveryQueryComponent(t *testing.T) {
	...
	variants := map[string]string{
		"other kind":         LookupFingerprint("role", "digest-1", authmodel.PrincipalRef{Type: "user", ID: "u1"}, "view", "project"),
		"other model digest": LookupFingerprint("relationship", "digest-2", authmodel.PrincipalRef{Type: "user", ID: "u1"}, "view", "project"),
		"other principal id": LookupFingerprint("relationship", "digest-1", authmodel.PrincipalRef{Type: "user", ID: "u2"}, "view", "project"),
		"other principal type": LookupFingerprint("relationship", "digest-1",
			authmodel.PrincipalRef{Type: "service_account", ID: "u1"}, "view", "project"),
		"other permission":    LookupFingerprint("relationship", "digest-1", authmodel.PrincipalRef{Type: "user", ID: "u1"}, "edit", "project"),
		"other resource type": LookupFingerprint("relationship", "digest-1", authmodel.PrincipalRef{Type: "user", ID: "u1"}, "view", "dashboard"),
	}
	...
	if LookupFingerprint("relationship", "digest-1", authmodel.PrincipalRef{Type: "user", ID: "u1"}, "view", "project") !=
		LookupFingerprint("relationship", "digest-1", authmodel.PrincipalRef{Type: "user", ID: "u1"}, "view", "project") {
		t.Fatal("the fingerprint must be deterministic")
	}
	if LookupFingerprint("relationship", "digest-1", authmodel.PrincipalRef{Type: "us", ID: "eru1"}, "view", "project") == base {
