...
-- silent overwrite (mutation.Receipt, AZ3-0.4). Turso dialect of the pgx 0004 —
...
-- schema no longer accepts that relation (AZ3-0.2/AZ3-0.4). created_at is a
-- fixed-width ISO-8601 TEXT timestamp (lexicographic == chronological); a replay
-- preserves it.
