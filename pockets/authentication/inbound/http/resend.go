...
func (h *handlers) resendVerification(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.svc.ResendVerification(r.Context(), req.Email); err != nil {
		switch {
		case errors.Is(err, authlogic.ErrVerificationResendRateLimited):
