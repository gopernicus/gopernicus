...
func (h *handlers) beginStepUpJSON(w http.ResponseWriter, r *http.Request) {
	...
	receipt, err := h.svc.BeginStepUp(r.Context(), authlogic.StepUpStart{
		SessionID: sessionID,
		UserID:    userID,
		Purpose:   req.Purpose,
		Context:   req.Context,
...
func (h *handlers) completeStepUpPasswordJSON(w http.ResponseWriter, r *http.Request) {
	...
	grant, err := h.svc.CompleteStepUpWithPassword(r.Context(), authlogic.StepUpCompletion{
		SessionID: sessionID,
		UserID:    userID,
		Purpose:   req.Purpose,
		Context:   req.Context,
...
func (h *handlers) completeStepUpCodeJSON(w http.ResponseWriter, r *http.Request) {
	...
	grant, err := h.svc.CompleteStepUpWithIdentifierCode(r.Context(), authlogic.StepUpCompletion{
		SessionID: sessionID,
		UserID:    userID,
		Purpose:   req.Purpose,
		Context:   req.Context,
