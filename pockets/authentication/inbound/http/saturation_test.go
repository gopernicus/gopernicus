...
// testQueue is the delivery outbox seam authenticationFixture.Queue accepts (matching stubQueue and
...
// newSaturationHandler builds a real authlogic.Service over in-memory fakes with the given
