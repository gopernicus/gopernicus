...
// The map key is the API-facing field name (it coincides with the column).
// created_at is the indexed spine column both invitation list ports page by; the
// id tiebreak is applied by the store, not listed here.
