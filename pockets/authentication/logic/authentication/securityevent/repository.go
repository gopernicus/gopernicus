...
//
// List is list-typed (design §9). Ordering is CONTRACTUAL: results are always
...
type SecurityEventRepository interface {
	...
	List(ctx context.Context, filter ListFilter, req list.Request) (list.Page[SecurityEvent], error)
}
