...
// plaintext), minting its record ID from ids (empty under sdk.DatabaseID —
...
func New(ids sdk.IDGenerator, serviceAccountID, name, keyPrefix, keyHash string, expiresAt, now time.Time) (APIKey, error) {
