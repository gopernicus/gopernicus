...
// withResolver wires the invitation resolver into the OAuth harness constructorConfig.
func withResolver(r invitationResolver) func(*constructorConfig) {
	return func(d *constructorConfig) { d.Invitations = r }
}
