...
func emailID(id string, login, recovery bool) IdentifierMethod {
	return IdentifierMethod{ID: id, Kind: sdk.AddressKindEmail, Verified: true, Uses: IdentifierUses{Login: login, Recovery: recovery}}
}

func phoneID(id string, login, recovery bool) IdentifierMethod {
	return IdentifierMethod{ID: id, Kind: sdk.AddressKindPhone, Verified: true, Uses: IdentifierUses{Login: login, Recovery: recovery}}
}
...
func TestDefaultPolicyIgnoresUnverifiedAndUnknownKinds(t *testing.T) {
	...
	set := MethodSet{
		...
		Identifiers: []IdentifierMethod{
			{ID: "e1", Kind: sdk.AddressKindEmail, Verified: false, Uses: IdentifierUses{Login: true, Recovery: true}},
...
func TestWithMutations(t *testing.T) {
	base := MethodSet{
		...
		Identifiers: []IdentifierMethod{
			{ID: "e1", Kind: sdk.AddressKindEmail, Verified: true, Primary: true, Uses: IdentifierUses{Login: true, Recovery: true}},
			{ID: "e2", Kind: sdk.AddressKindEmail, Verified: true, Uses: IdentifierUses{Recovery: true}},
		},
	}
