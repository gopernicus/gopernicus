...
// IdentifierMethod is one identifier in a MethodSet. Kind is an address-kind
// string (sdk.AddressKindEmail / sdk.AddressKindPhone); Uses records the roles it
