...
//
//   - ConsumeCode resolves the live (subject key, purpose) row. The subject key
//     may include a session/operation binding; the returned UserID remains the
//     actual owner. It decides expiry, selects
...
type Repository interface {
	...
	// ConsumeCode atomically evaluates the (subjectKey, purpose) code challenge
	...
	ConsumeCode(ctx context.Context, subjectKey, purpose string, candidates []DigestCandidate,
