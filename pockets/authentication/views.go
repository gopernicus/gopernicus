...
import inbound "github.com/gopernicus/gopernicus/pockets/authentication/internal/inbound/authentication"

// Views is the authentication pocket's HTML rendering port (FS3, design §9.2).
...
// in the sibling module pockets/authentication/views/templ; the blessed
...
// (design §9.2). The pocket core never imports templ.
