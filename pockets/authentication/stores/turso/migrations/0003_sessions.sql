...
-- bleed). previous_used flags a consumed grace slot (0/1). Timestamps are
-- fixed-width TEXT; Get filters on expires_at at the read clock (expired-at-read).
...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    previous_used               INTEGER NOT NULL DEFAULT 0,
