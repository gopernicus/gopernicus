...
import (
	...
	inbound "github.com/gopernicus/gopernicus/pockets/authentication/internal/inbound/authentication"
...
// of the pocket-built fields (Link included for context); the returned map is
