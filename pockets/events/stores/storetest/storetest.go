...
func Run(t *testing.T, newRepo func(t *testing.T) outbox.EntryRepository) {
	...
	t.Run("RecordOwnership", func(t *testing.T) { testRecordOwnership(t, newRepo(t)) })
	t.Run("OpaquePayloads", func(t *testing.T) { testOpaquePayloads(t, newRepo(t)) })
	t.Run("InvalidBatchIsAtomic", func(t *testing.T) { testInvalidBatchIsAtomic(t, newRepo(t)) })
