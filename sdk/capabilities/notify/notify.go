...
// future work, not now.
//
// Kind values are the sdk/foundation/identity Address-kind vocabulary (identity.KindEmail,
// identity.KindPhone, or any open string a provider declares). The intra-sdk
// import of sdk/foundation/identity for Address is a self-module import (G1-legal).
package notify
