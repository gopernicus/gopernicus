...
func TestRenderWithLayout_WithTextTemplate(t *testing.T) {
	...
	data := map[string]any{"Message": "System is down"}
...
// registerContent directly registers a parsed template in the registry, used
// by tests to seed content without an embed.FS.
