...
// populates the struct that sdk/foundation/logging declares. The dependency is test-only —
// sdk/foundation/logging has no production import of sdk/foundation/environment.
