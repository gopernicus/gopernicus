...
// NewOrder constructs an Order value. If direction is not ASC or DESC, it
// defaults to ASC.
...
// ParseOrder parses a "field:direction" string into an Order value. fields maps
// API-facing field names to OrderField definitions. An empty orderBy returns
// defaultOrder; direction is case-insensitive. An unknown field or an unknown
