...
| `id` | dependency-free random IDs (`crypto/rand`) — nanoid-shaped `New()` (21 chars, confusion-free alphabet), `NewCustom(alphabet, size)` for host-defined shapes, stdlib `UUID()` (v4) |
