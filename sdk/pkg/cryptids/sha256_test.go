...
func TestSHA256(t *testing.T) {
	...
	t.Run("deterministic", func(t *testing.T) {
		h1, _ := SHA256("same-key")
		h2, _ := SHA256("same-key")
		if h1 != h2 {
	...
	t.Run("case sensitive", func(t *testing.T) {
		h1, _ := SHA256("password")
		h2, _ := SHA256("Password")
		if h1 == h2 {
