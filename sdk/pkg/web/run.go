...
// transport/process orchestration a host owns; it lives in sdk/pkg/web so any host
// can serve a router without re-implementing graceful shutdown.
// If draining expires, Run closes remaining connections and returns the error.
// Hijacked connections and handlers that ignore cancellation remain host-owned.
