...
// FieldError is the response representation of an [sdk.Violation]. Code is
// omitted when the violation provides only a field and message.
...
// the error carries a [sdk.ValidationError], the response
