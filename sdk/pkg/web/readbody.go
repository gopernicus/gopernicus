...
//	}
//
// For a PATCH, guard each getter with [Body.Has] and record presence in the
// domain-owned update input. The domain decides whether null clears a field
// and how omitted values behave.
type Body struct {
...
// layout (YYYY-MM-DD, zero-padded) and returned at midnight UTC.
//
