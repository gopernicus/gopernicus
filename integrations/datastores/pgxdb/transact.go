...
// Transact implements sdk/foundation/crud.Transactor: it begins a transaction,
// stashes the *Tx in the context under the connector's private key, and calls
// fn. A nil return COMMITS; a non-nil error ROLLS BACK and is returned
// unwrapped; a panic inside fn ROLLS BACK and re-panics (the deferred rollback
// runs during unwind — no recover). Repositories inside fn reach the
// transaction through TxFromContext or QuerierFrom.
