...
// PrettyPrintSQL normalizes SQL whitespace for logging and tracing: it joins
// multi-line SQL onto a single line, strips tabs, trims whitespace around
// parentheses, and collapses runs of spaces.
