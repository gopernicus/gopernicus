// Package rebacrelationshipsbridge provides HTTP bridge for RebacRelationship operations.
...
// Bridge provides HTTP handlers for RebacRelationship operations.
type Bridge struct {
	rebacRelationshipRepository *rebacrelationships.Repository
	log                         *slog.Logger
...
func NewBridge(
	...
	b := &Bridge{
		rebacRelationshipRepository: rebacRelationshipRepository,
		log:                         log,
