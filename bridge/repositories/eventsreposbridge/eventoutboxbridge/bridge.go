// Package eventoutboxbridge provides HTTP bridge for EventOutbox operations.
...
// Bridge provides HTTP handlers for EventOutbox operations.
type Bridge struct {
	eventOutboxRepository *eventoutbox.Repository
	log                   *slog.Logger
