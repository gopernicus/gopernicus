// Package tenantsbridge provides HTTP bridge for Tenant operations.
...
// Bridge provides HTTP handlers for Tenant operations.
type Bridge struct {
	tenantRepository *tenants.Repository
	log              *slog.Logger
