// Package apikeysbridge provides HTTP bridge for APIKey operations.
...
// Bridge provides HTTP handlers for APIKey operations.
type Bridge struct {
	apiKeyRepository *apikeys.Repository
	log              *slog.Logger
