// Package principalsbridge provides HTTP bridge for Principal operations.
...
// Bridge provides HTTP handlers for Principal operations.
type Bridge struct {
	principalRepository *principals.Repository
	log                 *slog.Logger
