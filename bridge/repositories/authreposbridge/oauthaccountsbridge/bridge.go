// Package oauthaccountsbridge provides HTTP bridge for OauthAccount operations.
...
// Bridge provides HTTP handlers for OauthAccount operations.
type Bridge struct {
	oauthAccountRepository *oauthaccounts.Repository
	log                    *slog.Logger
