// Package verificationcodesbridge provides HTTP bridge for VerificationCode operations.
...
// Bridge provides HTTP handlers for VerificationCode operations.
type Bridge struct {
	verificationCodeRepository *verificationcodes.Repository
	log                        *slog.Logger
