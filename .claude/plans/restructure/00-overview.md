...
| D7 | `features/cms` core carries templ/goldmark/bluemonday (view deps) | **RATIFIED 2026-07-02: accept for now** | "Datastore-free" is the hygiene rule that matters; a headless host is hypothetical. Revisit if one materializes |
