...
// GenerateUUID creates a random (version 4) UUID in canonical form, e.g.
// "9b2af31c-6c3f-4e6a-9a2b-1c5d8e0f4a7d". Use it for primary keys backed by
// a database uuid column, where GenerateID's URL-safe alphabet is rejected.
